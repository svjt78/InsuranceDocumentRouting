...
# Import the bucket mappings router
from .bucket_mappings import router as bucket_mappings_router

# Import the emaul_settings
from . import email_settings  # Import your new module
...
app = FastAPI(
    ...
    description="Handles uploads, OCR, classification of insurance documents, and MinIO bucket mapping management."
)
...
def startup():
    ...
    try:
        # Create all tables (this now includes the new BucketMapping table)
...
# Include the new bucket mapping endpoints under /bucket-mappings
app.include_router(bucket_mappings_router)

# Include the email settings router
